...
export const PortfolioII = ({ handleChangeFocus, focusContact, slide }) => {

  return (
    <>
      <section className="portfolio__wrap">
      <article className="portfolio__text container">
      Коммерческий проект сайта агента оператора мультисервисной сети связи компании МТТ по продаже телефонных номеров для бизнеса корпоративным и частным клиентам
      </article>
